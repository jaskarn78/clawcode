...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 999.10-00-01 | 00 | 0 | Wave 0 — test scaffolding | unit | `npx vitest run src/manager/__tests__/secrets-resolver.test.ts` | ❌ W0 | ⬜ pending |
| 999.10-01-01 | 01 | 1 | SEC-01 | unit | `npx vitest run src/manager/__tests__/secrets-resolver-callsites.test.ts` | ❌ W0 | ⬜ pending |
| 999.10-01-02 | 01 | 1 | SEC-02 | unit | `npx vitest run secrets-resolver.test.ts -t "RES-01: cache hit avoids opRead"` | ❌ W0 | ⬜ pending |
| 999.10-01-03 | 01 | 1 | SEC-02 | unit | `npx vitest run secrets-resolver.test.ts -t "RES-02: inflight dedup"` | ❌ W0 | ⬜ pending |
| 999.10-01-04 | 01 | 1 | SEC-03 | unit | `npx vitest run secrets-resolver.test.ts -t "RES-03: retry succeeds before exhaustion"` | ❌ W0 | ⬜ pending |
| 999.10-01-05 | 01 | 1 | SEC-03 | unit | `npx vitest run secrets-resolver.test.ts -t "RES-04: rate-limit bails early"` | ❌ W0 | ⬜ pending |
| 999.10-01-06 | 01 | 1 | SEC-03 | unit | `npx vitest run secrets-resolver.test.ts -t "RES-05: empty resolution throws AbortError"` | ❌ W0 | ⬜ pending |
| 999.10-02-01 | 02 | 2 | SEC-04 | unit | `npx vitest run secrets-resolver.test.ts -t "RES-06: preResolveAll partial failure"` | ❌ W0 | ⬜ pending |
| 999.10-02-02 | 02 | 2 | SEC-04 | integration | `npx vitest run src/manager/__tests__/daemon-boot-secrets-degraded.test.ts` | ❌ W0 | ⬜ pending |
| 999.10-03-01 | 03 | 3 | SEC-05 | unit | `npx vitest run src/manager/__tests__/secrets-resolver-watcher.test.ts -t "WATCH-01: changed URI invalidates"` | ❌ W0 | ⬜ pending |
| 999.10-03-02 | 03 | 3 | SEC-05 | unit | extend `src/manager/__tests__/recovery-op-refresh.test.ts` REC-OP-REFRESH-INV-01 | ⚠️ EXTEND | ⬜ pending |
| 999.10-04-01 | 04 | 3 | SEC-06 | unit | `npx vitest run src/ipc/__tests__/secrets-status.test.ts` | ❌ W0 | ⬜ pending |
| 999.10-04-02 | 04 | 3 | SEC-06 | unit | `npx vitest run secrets-resolver.test.ts -t "RES-07: counters track lifecycle"` | ❌ W0 | ⬜ pending |
| 999.10-05-01 | 05 | 3 | SEC-07 | unit | `npx vitest run secrets-resolver.test.ts -t "RES-08: resolved value never logged"` | ❌ W0 | ⬜ pending |
| 999.10-05-02 | 05 | 3 | SEC-07 | unit | `npx vitest run secrets-resolver.test.ts -t "RES-09: error messages contain only URI"` | ❌ W0 | ⬜ pending |
