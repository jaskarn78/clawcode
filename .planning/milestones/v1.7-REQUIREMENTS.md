# Requirements Archive: v1.7 Performance & Latency
...
- [x] **PERF-03**: Concrete SLO targets documented per surface (e.g., first-token p50 ≤ 2s, end-to-end p95 ≤ 6s) and displayed on the dashboard
- [x] **PERF-04**: CI benchmark harness runs a fixed prompt set and fails the build when p95 regresses beyond a configurable threshold
...
- [x] **TOOL-03**: Per-tool round-trip timing logged and visible in the dashboard so slow tools are attributable
