...
- [x] 13-02-PLAN.md — Bridge integration for attachment download and forwarding
...
Plans:
- [x] 14-01-PLAN.md — Thread binding types, persistent registry, config schema extension
- [x] 14-02-PLAN.md — ThreadManager class, bridge thread detection and message routing
- [x] 14-03-PLAN.md — Idle cleanup heartbeat check, daemon wiring, CLI threads command
