...
**Plans:** 3 plans
Plans:
- [ ] 53-01-PLAN.md — Wave 1: @anthropic-ai/tokenizer install + countTokens helper + extended perf Zod (memoryAssemblyBudgets/lazySkills/resumeSummaryBudget) + ResolvedAgentConfig mirror + context-audit aggregator + clawcode context-audit CLI (filesystem-direct)
...
| 53. Context & Token Budget Tuning | 0/3 | Not started | — |
