...
**Plans:** 3 plans
Plans:
- [ ] 55-01-PLAN.md — Wave 1: Foundations — perf.tools Zod config (maxConcurrent/idempotent/slos) + TS mirror + canonicalStringify utility + TraceStore.getToolPercentiles + getPerToolSlo helper
...
| 55. Tool-Call Overhead | 0/3 | Planned | — |
