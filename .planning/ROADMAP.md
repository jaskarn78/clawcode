...
- [ ] 54-02-PLAN.md — Wave 2: Typing indicator relocation to DiscordBridge.handleMessage entry + typing_indicator span (4 guard conditions: routed agent + ACL + non-bot + user-message-type) + silent-swallow failure handling
...
| 54. Streaming & Typing Indicator | 1/4 | In Progress|  |
