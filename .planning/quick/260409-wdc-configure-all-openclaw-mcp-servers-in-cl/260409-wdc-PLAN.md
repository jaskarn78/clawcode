...
2. **finmentum-db** — command: `mcporter`, args: ["serve", "mysql"], env: MYSQL_HOST=100.117.234.17, MYSQL_PORT=3306, MYSQL_USER=jjagpal, MYSQL_PASSWORD=op://clawdbot/Finmentum DB/password, MYSQL_DATABASE=finmentum
