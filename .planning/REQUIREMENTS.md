...
- [x] **DISC-02**: Incoming Discord messages route to the correct agent based on channel binding
- [x] **DISC-03**: Agent responses are delivered back to the originating Discord channel
